...
sender_value = st.text_input("Please enter senders information")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_value = st.text_input("Please enter receivers information")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_value = st.text_input("Please enter the amount to send")
